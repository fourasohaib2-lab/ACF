 ...
 * at every real airport in `AirportDatabase`
 * (GET /airports). No trend arrow: no real historical/previous-run
...
export function AirportComplexity() {
  ...
  return (
    <Panel className="flex h-full flex-col overflow-hidden">
      <PanelHeader title="Airport Complexity" subtitle={`${data.model} · nearest grid cell`} />
