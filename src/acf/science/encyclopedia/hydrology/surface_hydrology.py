...
ENTRIES: list[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={
            ...
            "psi": "Succion au front d'humectation (mm)",
            "Delta_theta": "Déficit en eau du sol",
            "F(t)": "Infiltration cumulée (mm)",
        },
    ...
    EncyclopediaEntry(
        ...
        variables={
            "f0": "Taux d'infiltration initial (mm/h)",
            "fc": "Taux d'infiltration d'équilibre (mm/h)",
            "k": "Constante de décroissance (h⁻¹)",
        },
        units={"f": "mm/h", "k": "h⁻¹"},
    ...
    EncyclopediaEntry(
        ...
        variables={
            "theta": "Humidité volumique du sol (m³/m³)",
            "psi": "Pression matricielle du sol (m)",
            "K(theta)": "Conductivité hydraulique (m/s)",
        },
        ...
        application_conditions=[
            "Couche de sol non saturée dans les modèles de surface (Land Surface Models ex: SURFEX, Noah-MP)"
        ],
        limitations=[
            "Fortement non-linéaire nécessitant des schémas d'intégration numériques implicites (van Genuchten / Clapp-Hornberger)"
        ],
    ...
    EncyclopediaEntry(
        ...
        variables={
            "I": "Débit d'entrée en amont (m³/s)",
            "Q": "Débit de sortie en aval (m³/s)",
            "K": "Temps de transit dans le bief (h)",
            "X": "Facteur de pondération de stockage (0 à 0.5)",
        },
        units={"Q": "m³/s", "I": "m³/s"},
    ...
    EncyclopediaEntry(
        ...
        variables={
            "C": "Coefficient de ruissellement (0 à 1)",
            "I": "Intensité de pluie moyenne pendant le temps de concentration (mm/h)",
