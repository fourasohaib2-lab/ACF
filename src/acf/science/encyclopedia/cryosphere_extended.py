...
ENTRIES: List[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={"alpha_fresh": "Albédo neige fraîche (~ 0.85)", "alpha_min": "Albédo neige ancienne mouillée (~ 0.50)", "k_aging": "Taux de vieillissement"},
        ...
        application_conditions=["Modèles de manteau neigeux (Crocus, SURFEX/ISBA-ES, Noah-MP) et prévision des avalanches"],
    ...
    EncyclopediaEntry(
        ...
        variables={"h": "Épaisseur de la glace de mer (m)", "k_ice": "Conductivité thermique de la glace (2.0 W/(m·K))", "Lf": "Chaleur latente de fusion (3.34e5 J/kg)"},
        units={"h": "m"},
