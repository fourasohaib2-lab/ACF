...
ENTRIES = [
    EncyclopediaEntry(
        ...
        variables={"x0": "État initial cherché (analyse)", "xb": "Ébauche (background)", "B": "Matrice de covariance d'erreur de background", "y": "Observations", "R": "Matrice d'erreur d'observation"},
