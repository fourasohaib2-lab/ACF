...
ENTRIES: List[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={"u": "Vitesse advective maximale (m/s)", "dt": "Pas de temps d'intégration (s)", "dx": "Résolution de maille spatiale (m)"},
        ...
        limitations=["Les schémas semi-lagrangians ou implicites permettent d'affranchir le pas de temps de la limite CFL (C > 1)"],
        references=["Courant, Friedrichs & Lewy (1928) Math. Ann.", "Durran (2010) Numerical Methods for Fluid Dynamics"],
    ...
    EncyclopediaEntry(
        ...
        limitations=["Valide strictly pour les équations à coefficients constants à conditions aux limites périodiques"],
    ...
    EncyclopediaEntry(
        ...
        variables={"u": "Champ solution approximé sur éléments", "v": "Fonction test (Galerkin)", "Omega": "Domaine spatial"},
        ...
        limitations=["Nécessite l'inversion de matrices de masse globales à chaque pas de temps (sauf en Éléments Finis Discontinus DGFEM)"],
    ...
    EncyclopediaEntry(
        ...
        limitations=["Nécessite la gestion exacte de la mémoire des états sauvegardés lors du parcours arrière (checkpoints)"],
