...
ENTRIES: list[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={
            ...
            "c": "Vitesse de la lumière (3e8 m/s)",
            "kB": "Constante de Boltzmann (1.38e-23 J/K)",
    ...
    EncyclopediaEntry(
        ...
        variables={
            ...
            "emissivity": "Émissivité de la surface",
        },
        units={"E": "W/m²"},
    ...
    EncyclopediaEntry(
        ...
        variables={
            "tau_lambda": "Épaisseur optique spectrale intégrée",
            "k_lambda": "Coefficient d'extinction massique",
        },
        units={"I": "W/(m²·sr·µm)"},
