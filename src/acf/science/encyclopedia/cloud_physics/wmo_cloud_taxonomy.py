...
def calculate_hallett_mossop_splintering(temp_c: float, rime_rate_mg_s: float) -> float:
    ...
    efficiency = 1.0 - abs(temp_c + 5.5) / 2.5
...
ENTRIES: List[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={"Espèces principales": "fibratus, uncinus, spissatus, castellanus, lenticularis, congestus, humilis, mediocris, fractus"},
        ...
        application_conditions=["Observation météorologique internationale (WMO-No. 407 Atlas International des Nuages)"],
        limitations=["Nécessite une observation visuelle qualifiée ou une analyse d'images satellitaires haute résolution"],
    ...
    EncyclopediaEntry(
        ...
        variables={"Mamma": "Poches de subsidence sous l'enclume", "Asperitas": "Ondulations chaotiques sous la base nuageuse", "Arcus": "Rouleau frontal de rafales"},
    ...
    EncyclopediaEntry(
        ...
        variables={"Soot_aerosols": "Suies servant d'INP/CCN massifs", "Altitude_injection": "10 à 18 km (Stratosphère)"},
        units={"Altitude": "km"},
    ...
    EncyclopediaEntry(
        ...
        variables={"T": "Température zone de givrage (-3°C à -8°C)", "dqg/dt": "Taux d'accrétion de gouttes surfrondues sur graupel"},
        units={"N_ice": "m⁻³·s⁻¹"},
        ...
        application_conditions=["Zone de givrage convective entre -3°C et -8°C avec présence simultanée de petites et grosses gouttes"],
