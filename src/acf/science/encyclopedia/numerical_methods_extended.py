...
ENTRIES: list[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={
            "Omega_e": "Élément géométrique local",
            "F_hat": "Flux numérique de Riemann aux interfaces inter-éléments",
        },
    ...
    EncyclopediaEntry(
        ...
        variables={
            "S": "Fraction séquentielle du code",
            "P": "Nombre de processeurs/GPU",
            "T_comms": "Surcoût des échanges réseau MPI",
        },
