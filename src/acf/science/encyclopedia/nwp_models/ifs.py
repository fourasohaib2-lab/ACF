...
ENTRIES = [
    EncyclopediaEntry(
        ...
        variables={
            "Résolution": "TCo1279 (~ 9 km global)",
            "Niveaux": "137 niveaux verticaux",
            "Cœur": "Spectral sphérique (Ylm) + Semi-Lagrangien",
        },
        ...
        application_conditions=[
            "Prévision numérique globale à moyen terme (0 à 15 jours) et prévision d'ensemble (EPS 51 membres)"
        ],
        limitations=["Hypothèse hydrostatique nécessitant une paramétrisation sous-maille de la convection profonde"],
        references=[
            "ECMWF IFS Documentation (Cy48r1/Cy49r1)",
            "Untch & Hortal (2004) Q. J. R. Meteorol. Soc.",
            "WMO NWP Reports",
        ],
    ),
    EncyclopediaEntry(
        ...
        variables={
            "Anm": "Coefficients spectraux",
            "Pnm": "Polynômes associés de Legendre",
            "lambda": "Longitude",
            "mu": "sin(latitude)",
        },
    ...
    EncyclopediaEntry(
        ...
        variables={
            "x0": "État initial cherché",
            "xb": "Ébauche (background)",
            "M": "Modèle pronostique non-linéaire / tangent linéaire",
        },
