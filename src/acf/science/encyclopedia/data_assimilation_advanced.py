...
ENTRIES: List[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={"B_static": "Matrice de covariance des erreurs d'ébauche statique climatologique", "P_ensemble": "Matrice de covariance dépendante du temps estimée par l'ensemble (EnKF)", "alpha": "Facteur de pondération (0.2 à 0.5)"},
        ...
        application_conditions=["Systèmes d'assimilation opérationnels modernes (ECMWF IFS, NOAA GFS/FV3, Météo-France AROME-Ensemble)"],
        limitations=["Nécessite la localisation des covariances d'ensemble pour éliminer le bruit d'échantillonnage à grande distance"],
        references=["Lorenc (2003) Q. J. R. Meteorol. Soc.", "Buehner et al. (2010) Mon. Wea. Rev.", "WMO Data Assimilation Manual"],
    ),
    EncyclopediaEntry(
        ...
        variables={"Xb": "Perturbations de l'ébauche de l'ensemble", "Yb": "Observations simulées par les membres", "R": "Matrice de covariance des erreurs d'observation"},
    ...
    EncyclopediaEntry(
        ...
        variables={"beta_i": "Predictor coefficients updated continuously inside 3D/4D-Var", "p_i": "Predicteurs physiques (ex: angle zénithal, épaisseur de couche)"},
