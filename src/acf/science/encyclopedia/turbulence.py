...
ENTRIES = [
    EncyclopediaEntry(
        ...
        variables={
            "E(k)": "Densité spectrale d'énergie cinétique",
            "k": "Nombre d'onde spatial",
            "epsilon": "Taux de dissipation de la TKE",
        ...
        compute_func=lambda wavenumber_k, dissipation_epsilon, Ck=1.5: (
            Ck * (dissipation_epsilon ** (2.0 / 3.0)) * (wavenumber_k ** (-5.0 / 3.0))
        ),
    ),
]
