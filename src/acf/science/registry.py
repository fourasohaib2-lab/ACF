...
class ScientificRegistry:
    ...
    @classmethod
    def get(cls, key_or_name: str) -> Optional[AtmosphericLaw]:
        """
    ...
    @classmethod
    def list_laws(cls, domain: Optional[str] = None) -> List[AtmosphericLaw]:
        """
        ...
        return [
            law for law in cls._registry.values()
            if domain_lower in law.domain.lower()
        ]
    ...
    def domains(cls) -> List[str]:
        ...
        """
        cls._ensure_initialized()
        return sorted(list(set(law.domain for law in cls._registry.values())))
