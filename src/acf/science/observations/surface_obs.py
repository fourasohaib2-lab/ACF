...
ENTRIES: list[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={
            "WIGOS_ID": "Identifiant universel WMO WIGOS",
            "P_sfc": "Pression station / QFF (Pa)",
            "T2m": "Température sous abri (K)",
            "Td2m": "Point de rosée (K)",
            "WW": "Temps présent code WMO 4677",
        },
        ...
        limitations=[
            "Les biais de micro-climat local et d'exposition des abris doivent être corrigés par les modèles d'opérateurs d'observation"
        ],
    ...
    EncyclopediaEntry(
        ...
        variables={
            ...
            "P_msl": "Pression réduite au niveau de la mer (Pa)",
            "Hs": "Hauteur significative des vagues (m)",
        },
        units={"SST": "K", "Hs": "m"},
