...
ENTRIES: List[EncyclopediaEntry] = [
    EncyclopediaEntry(
        ...
        variables={"Wind": "Direction (deg) et Vitesse (kt)", "RVR": "Runway Visual Range (m)", "Clouds": "Couverture (FEW, SCT, BKN, OVC) et hauteur (ft)", "QNH": "Altimètre (hPa)"},
        ...
        application_conditions=["Protection de la navigation aérienne, décollage/atterrissage et assimilation d'aérodrome"],
    ...
    EncyclopediaEntry(
        ...
        variables={"T": "Temperature de l'air extérieure (K)", "V": "Vecteur vent (m/s)", "EDR": "Equivalent Eddy Dissipation Rate (Turbulence)"},
        ...
        application_conditions=["Assimilation synoptique haute résolution 4D-Var / EnVar dans IFS, AROME, GFS, Rapid Refresh"],
