...
def observe_radar_doppler_radial_velocity(u_ms: float, v_ms: float, w_ms: float, azimuth_deg: float, elevation_deg: float) -> float:
    """
    ...
    return (u_ms * math.sin(az_rad) * math.cos(el_rad) +
