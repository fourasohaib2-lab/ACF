...
Real module moved to ``acf.science.dynamics.wind`` on
...
Kept here so every existing ``acf.science.wind`` import keeps
working unchanged.
"""

from acf.science.dynamics.wind import *  # noqa: F401,F403
