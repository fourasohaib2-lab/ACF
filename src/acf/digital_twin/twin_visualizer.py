    ...
    def get_visualization_modes(cls) -> Dict[str, Any]:
        return {
            "modes": [
                ...
                {"name": "Alternative Earth (Net-Zero)", "horizon": "2050", "active_data": "SSP1-1.9 Decarbonization Scenario"},
                {"name": "Alternative Earth (Geoengineering)", "horizon": "2050", "active_data": "SAI Aerosol Injection Scenario"},
            ],
