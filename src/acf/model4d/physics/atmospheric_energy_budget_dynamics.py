...
class AtmosphericEnergyBudgetDynamics:
    ...
    def cloud_energy_feedback(self, state: EnergyBudgetState) -> float:
        ...
        return round(
            state.cloud_effect / 2,
            2
        )



    def atmospheric_energy_balance(
        self,
