...
class AtmosphericRadiationDynamics:
    ...
    def absorbed_radiation(self, state):
        ...
        result = state.solar_flux * state.atmospheric_absorption
    ...
    def infrared_emission(self, state):
        ...
        result = self.STEFAN_BOLTZMANN * state.surface_temperature**4 * state.emissivity
    ...
    def outgoing_longwave_radiation(self, state):
        ...
        result = state.infrared_flux * (1 - state.greenhouse_factor)
    ...
    def greenhouse_effect(self, state):
        ...
        result = state.infrared_flux * state.greenhouse_factor
    ...
    def radiative_balance(self, state):
        ...
        incoming = state.solar_flux * state.atmospheric_absorption

        outgoing = state.infrared_flux * (1 - state.greenhouse_factor)
    ...
    def radiative_cooling(self, state):
        ...
        result = state.atmospheric_temperature * state.emissivity * 0.01
    ...
    def radiative_equilibrium(self, state):
        ...
        result = state.surface_temperature - state.greenhouse_factor * 10
