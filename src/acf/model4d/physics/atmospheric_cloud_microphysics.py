...
MODEL4D - Atmospheric Cloud Microphysics
...
Responsibilities:
-----------------
• Manage atmospheric cloud microphysics logic and state representations.
• Integrate with the model4d subsystem of the ACF scientific engine.

Major Components:
-----------------
• CloudMicrophysicsState, AtmosphericCloudMicrophysics
