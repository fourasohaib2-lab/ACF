...
class DataRenderer:
    ...
    def create_layer(
        ...
        real_variable = self.find_variable(
            dataset,
            variable
        )
        ...
        layer = self.scientific.create_layer(
            dataset,
            real_variable,
            real_variable
        )
    ...
    def get_colormap(
        ...
        return self.scientific.get_colormap(
            variable
        )
