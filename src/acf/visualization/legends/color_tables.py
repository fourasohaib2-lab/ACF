...
class ColorTableRegistry:
    ...
    COLOR_MAPS: Dict[str, List[Tuple[float, str]]] = {
        ...
        "temperature_wmo": [
            (-60.0, "#4A00E0"), (-40.0, "#0055FF"), (-20.0, "#00AAFF"), (0.0, "#00FFFF"),
            (10.0, "#00FF55"), (20.0, "#FFFF00"), (30.0, "#FF7700"), (45.0, "#FF0000"),
        ],
        # 2. NEXRAD Radar Reflectivity (dBZ)
        "radar_reflectivity": [
            (5.0, "#00ECEC"), (15.0, "#01A0F6"), (25.0, "#0000F6"), (35.0, "#00FF00"),
            (45.0, "#00C800"), (50.0, "#FFFF00"), (55.0, "#E7C000"), (60.0, "#FF0000"),
            (65.0, "#D60000"), (70.0, "#C00000"), (75.0, "#FF00FF"),
        ],
        # 3. Severe Storm CAPE (J/kg)
        "cape_severe": [
            (0.0, "#FFFFFF"), (250.0, "#C0E0FF"), (500.0, "#80B0FF"), (1000.0, "#00FF00"),
            (2000.0, "#FFFF00"), (3000.0, "#FF7700"), (4000.0, "#FF0000"), (6000.0, "#A000FF"),
        ],
        # 4. Satellite IR Cloud Top Temperature (K)
        "satellite_ir_ctt": [
            (180.0, "#FFFFFF"), (200.0, "#FF00FF"), (220.0, "#FF0000"), (240.0, "#FFFF00"),
            (260.0, "#00FF00"), (280.0, "#00FFFF"), (300.0, "#000080"),
        ],
        # 5. Wind Velocity (m/s / knots)
        "wind_speed": [
            (0.0, "#FFFFFF"), (5.0, "#99CCFF"), (10.0, "#0066FF"), (20.0, "#00CC00"),
            (30.0, "#FFFF00"), (40.0, "#FF6600"), (50.0, "#FF0000"), (75.0, "#CC00CC"),
        ],
    }
