...
EQUATION_CATALOG: dict[str, PhysicalEquationEntry] = {
    ...
    "hypsometric_equation": PhysicalEquationEntry(
        equation_id="hypsometric_equation",
        name="Hypsometric Equation",
        category="Thermodynamics & Dynamics",
        latex_formula=r"\Delta z = \frac{R_d \bar{T_v}}{g} \ln\left(\frac{p_1}{p_2}\right)",
        text_formula="dz = (Rd * Tv_bar / g) * ln(p1 / p2)",
        si_units_summary="m (layer thickness)",
        assumptions=["Hydrostatic balance", "Ideal gas law", "Layer-mean virtual temperature"],
        validity_domain="Thickness/geopotential-height computation between two pressure levels",
        variables_map={
            "Rd": "Dry air specific gas constant (287.05 J/(kg*K))",
            "Tv_bar": "Layer-mean virtual temperature (K)",
            "g": "Standard gravity (9.80665 m/s^2)",
            "p1": "Lower-level pressure (Pa)",
            "p2": "Upper-level pressure (Pa)",
        },
        scientific_references=["Holton & Hakim (2012) An Introduction to Dynamic Meteorology", "AMS Glossary of Meteorology"],
    ),
    "potential_temperature": PhysicalEquationEntry(
        equation_id="potential_temperature",
        name="Poisson Equation (Potential Temperature)",
        category="Thermodynamics",
        latex_formula=r"\theta = T \left( \frac{p_0}{p} \right)^{R_d / c_p}",
        text_formula="theta = T * (p0 / p)^(Rd/cp)",
        si_units_summary="K",
        assumptions=["Dry adiabatic (isentropic) process", "Ideal gas behaviour"],
        validity_domain="Reduction of temperature to a common reference pressure (dry atmosphere)",
        variables_map={
            "theta": "Potential temperature (K)",
            "T": "Absolute temperature (K)",
            "p0": "Reference pressure, conventionally 1000 hPa",
            "p": "Ambient pressure (same units as p0)",
            "Rd/cp": "Poisson exponent kappa, approx 0.286 for dry air",
        },
        scientific_references=["Poisson (1823)", "Holton & Hakim (2012) An Introduction to Dynamic Meteorology"],
    ),
    "cape": PhysicalEquationEntry(
        equation_id="cape",
        name="Convective Available Potential Energy (CAPE)",
        category="Thermodynamics",
        latex_formula=r"\mathrm{CAPE} = \int_{z_{LFC}}^{z_{EL}} g \, \frac{T_{v,parcel} - T_{v,env}}{T_{v,env}} \, dz",
        text_formula="CAPE = integral[z_LFC to z_EL] g * (Tv_parcel - Tv_env) / Tv_env dz",
        si_units_summary="J/kg",
        assumptions=[
            "Parcel theory (undiluted ascent)",
            "Hydrostatic environment",
            "Integration limited to layers of positive buoyancy (LFC to EL)",
        ],
        validity_domain="Severe convection / thunderstorm potential diagnosis",
        variables_map={
            "g": "Standard gravity (9.80665 m/s^2)",
            "Tv_parcel": "Virtual temperature of the lifted parcel (K)",
            "Tv_env": "Virtual temperature of the environment (K)",
            "z_LFC": "Level of free convection (m)",
            "z_EL": "Equilibrium level (m)",
        },
        scientific_references=[
            "Doswell & Rasmussen (1994) Weather and Forecasting 9(4)",
