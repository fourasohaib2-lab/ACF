...
class MissionPlanner:
    ...
    def get_active_workflows(cls) -> List[AutonomousWorkflowTask]:
        ...
        return [
            ...
            AutonomousWorkflowTask("TSK-02", "Neural AI Forecast Inference (GraphCast)", "acf.ai", 60, "ACTIVE / SCHEDULED"),
            AutonomousWorkflowTask("TSK-03", "Multi-Hazard Cascade Risk Audit", "acf.intelligence", 30, "ACTIVE / RUNNING"),
            AutonomousWorkflowTask("TSK-04", "Executive Briefing Report Generation", "acf.reports", 360, "ACTIVE / SCHEDULED"),
        ]
