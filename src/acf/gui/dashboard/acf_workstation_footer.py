...
Sources/Running Jobs come from the real
`acf.hpc_connector.HPCConnectionManager.get_status_summary()`
...
the panel shows an honest "Not Connected" placeholder - it must never
default to a connected/healthy look just because the UI itself is
running.
"""
...
class SystemFooterPanel(QWidget):
    ...
    def update_from_hpc(self, hpc: Any) -> None:
        """Refresh System Status/Running Jobs from a real HPCConnectionManager.
