...
Real module moved to ``awci.dashboard.awci_synthetic_field`` on 2026-09-21
...
here so every existing ``acf.gui.dashboard.awci_synthetic_field`` import keeps
working unchanged.
"""

from awci.dashboard.awci_synthetic_field import *  # noqa: F401,F403
...
# re-export here too.
from awci.dashboard.awci_synthetic_field import _synthetic_inputs  # noqa: F401
