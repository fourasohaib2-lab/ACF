...
Real module moved to ``awci.dashboard.awci_cross_section`` on 2026-09-21
...
here so every existing ``acf.gui.dashboard.awci_cross_section`` import keeps
working unchanged.
"""

from awci.dashboard.awci_cross_section import *  # noqa: F401,F403
...
# re-export here too.
from awci.dashboard.awci_cross_section import _hpa_to_ft  # noqa: F401
