...
Real module moved to ``awci.dashboard.awci_topbar`` on 2026-09-21
...
here so every existing ``acf.gui.dashboard.awci_topbar`` import keeps
working unchanged.
"""

from awci.dashboard.awci_topbar import *  # noqa: F401,F403
...
# re-export here too.
from awci.dashboard.awci_topbar import _ElidingLabel  # noqa: F401
