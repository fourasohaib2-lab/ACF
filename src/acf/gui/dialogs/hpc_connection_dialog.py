"""HPC Connection Wizard & Profile Dialog (ACF-HPC-002).

Shared across ACF dashboards that need a real HPC connection (e.g. the
AWCI Dashboard's HPC execution path) - moved out of the former
acf.gui.esoc package (ESOC dashboard, removed) since it has no real
dependency on ESOC itself.
"""
