...
Responsibilities:
-----------------
• Manage converter logic and state representations.
...
empty scaffolding stub - no class, function, or conversion table exists
here despite the "Converter"/"unit conversion tables" purpose claimed
above and in acf.parameters/__init__.py. Not imported by anything in
src/ or tests/ (verified by grep). The real, working unit-conversion
