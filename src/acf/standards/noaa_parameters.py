"""
acf.standards.noaa_parameters - empty stub, no content beyond this file.
...
(verified by grep). No real NOAA parameter table exists anywhere in
...
(ecmwf_parameters.py, grib2_tables.py, wmo_tables.py).
"""
