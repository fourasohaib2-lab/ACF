...
from awci.dashboard.awci_colors import level_for, risk_qcolor
from awci.dashboard.awci_component_detail import COMPONENT_INFO
...
#: awci.complexity.calculator.AWCICalculator.INTERACTION_TERMS's own docstring
