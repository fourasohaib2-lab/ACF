...
awci.complexity.path_sampling.sample_field_along_path() result instead.
...
from awci.dashboard.awci_colors import AWCI_CMAP, level_for, risk_qcolor
from awci.dashboard.awci_synthetic_field import route_profile
