...
def compute_awci_cross_section_from_imported_dataset(
    ...
    *,
    ...
    """
    from awci.complexity.path_sampling import _haversine_km, sample_volume_cross_section
    ...
    if with_hazards:
        ...
        if all(key in volumes for key in needed):
            from awci.complexity.path_sampling import sample_cross_section_hazards
