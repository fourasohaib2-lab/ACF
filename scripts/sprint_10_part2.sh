...
echo "============================================="
echo " Sprint 10 - Partie 2"
echo " Surface Parameter Catalog"
echo "============================================="

cat > "$PROJECT/src/acf/catalog/surface_parameters.py" << 'EOF'
...
cat > "$PROJECT/tests/test_surface_catalog.py" << 'EOF'
...
echo
echo "Surface catalog installed."
