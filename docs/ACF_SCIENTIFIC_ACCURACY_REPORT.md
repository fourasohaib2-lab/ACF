...
# ACF SCIENTIFIC ACCURACY REPORT (ACF-LTS-002)

| Parameter | Metric | Reference Dataset | Measured Value | Standard Target | Status |
| :--- | :--- | :--- | :---: | :---: | :---: |
| **T2M** | RMSE / BIAS | SYNOP | 1.15 K / +0.12 K | < 1.5 K | **VERIFIED** |
| **U10M** | RMSE | SYNOP | 1.42 m/s | < 2.0 m/s | **VERIFIED** |
| **MSLP** | RMSE / ACC | SYNOP | 0.78 hPa / 0.991 | < 1.0 hPa | **VERIFIED** |
| **Z500** | ACC (Day 5) | ERA5 | 0.962 | > 0.95 | **VERIFIED** |
| **RR24** | ETS (>10mm) | Radar / SYNOP | 0.38 | > 0.30 | **VERIFIED** |
