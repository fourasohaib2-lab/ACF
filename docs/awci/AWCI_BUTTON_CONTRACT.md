...
| Wind/Turbulence/Icing/Convection/CAPE/Clouds checkboxes | — | "`<name>` has no real data source wired into this map panel yet" | always (`setEnabled(False)`) | n/a | none (real, honest, not a fake toggle) | n/a |
