...
def test_absorbed_energy():
    ...
    state = RadiativeBalanceState(solar_input=100, albedo=0.3, outgoing_longwave=50)
...
def test_energy_balance():
    ...
    state = RadiativeBalanceState(solar_input=100, albedo=0.2, outgoing_longwave=50)
...
def test_warming_state():
    ...
    state = RadiativeBalanceState(solar_input=100, albedo=0.1, outgoing_longwave=50)
...
def test_equilibrium_state():
    ...
    state = RadiativeBalanceState(solar_input=100, albedo=0.5, outgoing_longwave=50)
