from acf.model4d.physics.atmospheric_wave_source_generation import (
    AtmosphericWaveSourceGeneration,
    WaveSourceState
)
...
def test_name():
    ...
    assert (
        model.name
        ==
        "Atmospheric Wave Source Generation"
    )
