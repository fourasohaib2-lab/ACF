...
def test_condensation():
    ...
    state = CloudMicrophysicsState(temperature_anomaly=2, humidity=4, condensation_rate=0.5, cloud_fraction=1)
...
def test_cloud_formation():
    ...
    state = CloudMicrophysicsState(temperature_anomaly=2, humidity=4, condensation_rate=0.5, cloud_fraction=0.5)
...
def test_radiative_feedback():
    ...
    state = CloudMicrophysicsState(
        temperature_anomaly=1, humidity=4, condensation_rate=0.5, cloud_fraction=0.5, radiative_effect=2
    )
...
def test_cloud_state():
    ...
    state = CloudMicrophysicsState(temperature_anomaly=1, humidity=2, condensation_rate=1, cloud_fraction=1)
