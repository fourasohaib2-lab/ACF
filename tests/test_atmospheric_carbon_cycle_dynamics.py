...
def test_natural_sink():
    ...
    state = CarbonCycleState(emissions=100, ocean_uptake=30, vegetation_uptake=20)
...
def test_increasing_carbon():
    ...
    state = CarbonCycleState(emissions=100, ocean_uptake=20, vegetation_uptake=10)
...
def test_stable_carbon():
    ...
    state = CarbonCycleState(emissions=50, ocean_uptake=30, vegetation_uptake=20)
