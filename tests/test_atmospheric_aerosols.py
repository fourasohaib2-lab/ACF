...
def test_optical_depth():
    ...
    value = AtmosphericAerosolsPhysics.aerosol_optical_depth(0.5, 2)
...
def test_number_density():
    ...
    value = AtmosphericAerosolsPhysics.aerosol_number_density(1000, 10)
...
def test_mass_concentration():
    ...
    value = AtmosphericAerosolsPhysics.aerosol_mass_concentration(20, 10)
...
def test_growth_factor():
    ...
    value = AtmosphericAerosolsPhysics.hygroscopic_growth_factor(1, 1.5)
...
def test_radiative_forcing():
    ...
    value = AtmosphericAerosolsPhysics.radiative_forcing(0.5, 20)
...
def test_lifetime():
    ...
    value = AtmosphericAerosolsPhysics.aerosol_lifetime(100, 5)
...
def test_deposition_flux():
    ...
    value = AtmosphericAerosolsPhysics.deposition_flux(10, 0.2)
...
def test_surface_area():
    ...
    value = AtmosphericAerosolsPhysics.aerosol_surface_area(100, 0.01)
