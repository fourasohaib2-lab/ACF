...
def test_calculate_sensitivity():
    ...
    state = ClimateSensitivityState(forcing_wm2=2, feedback_parameter=1.5)
...
def test_equilibrium_factor():
    ...
    state = ClimateSensitivityState(forcing_wm2=2, feedback_parameter=1.5, equilibrium_factor=2)
...
def test_temperature_response():
    ...
    result = model.temperature_response(forcing=2, sensitivity=1.5)
...
def test_state_creation():
    ...
    state = ClimateSensitivityState(forcing_wm2=1, feedback_parameter=1)
