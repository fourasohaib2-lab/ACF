...
def test_name():
    ...
    assert model.name == ("Atmospheric Boundary Layer Dynamics")
...
def test_turbulence():
    ...
    state = BoundaryLayerState(
        wind_speed=10, temperature_difference=5, humidity_difference=2, surface_roughness=0.5, stability=1
    )
...
def test_sensible_heat_flux():
    ...
    state = BoundaryLayerState(wind_speed=20, temperature_difference=10, humidity_difference=5, surface_roughness=0.4)
...
def test_latent_heat_flux():
    ...
    state = BoundaryLayerState(wind_speed=10, temperature_difference=5, humidity_difference=4, surface_roughness=0.3)
...
def test_vertical_mixing():
    ...
    state = BoundaryLayerState(
        wind_speed=10, temperature_difference=5, humidity_difference=2, surface_roughness=0.5, stability=2
    )
